...
export const Route = createFileRoute("/clientes")({
  head: () => ({ meta: [{ title: "Clientes — Aurora" }, { name: "description", content: "Lista e detalhes de clientes." }] }),
  component: () => (
    <div className="min-h-[60vh] flex items-center justify-center">
      <div className="text-center max-w-md">
        ...
        <h1 className="text-3xl font-bold mt-4">Clientes</h1>
        <p className="text-muted-foreground mt-2">Lista e detalhes dos clientes ativos e em risco.</p>
